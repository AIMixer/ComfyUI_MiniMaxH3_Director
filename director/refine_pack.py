...
def pack_refine(
    *,
    ...
    clear_vram_before_refine: bool = True,
    decode_first_pass: bool = True,
    stage_first_pass_images: bool = True,
...
def normalize_refine_pack(
    ...
    *,
    ...
    return {
        ...
        "clear_vram_before_refine": bool(raw.get("clear_vram_before_refine", True)),
        "decode_first_pass": bool(raw.get("decode_first_pass", True)),
        "stage_first_pass_images": bool(raw.get("stage_first_pass_images", True)),
